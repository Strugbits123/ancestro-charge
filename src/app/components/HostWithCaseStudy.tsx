    ...
    <section className="relative flex flex-col w-full">
      ...
      <div className="relative w-full min-h-screen flex flex-col justify-center">
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto flex flex-col items-center text-center px-2">
          {/* Heading */}
          <h1 className="text-3xl md:text-5xl lg:text-[60px] xl:text-[80px] font-helevetica font-bold text-white leading mb-6 w-full">
        {t("host_charger_title").split("<br />").map((line, index) => (
          ...
          {/* Description */}
          <p className="text-base md:text-[26px] lg:text-[30px] font-helevetica text-gray-200 max-w-7xl mb-8">
            {t("host_charger_desc")}
          </p>

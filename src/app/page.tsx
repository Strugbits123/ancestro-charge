...
//          <Button label="APPLY TO HOST A CHARGE" small className="mt-8 w-full md:w-1/2" />
//     </div>
...
//     FROM NORTHERN MEXICO TO SOUTHERN ARGENTINA, <br className="hidden sm:block" />
//     ANCESTRO CHARGE IS CONNECTING THE DOTS.
//   </h2>
//   {/* Paragraph */}
...
//         Powered by the Ancestro Ecosystem
//       </h2>
...
//     style={{ backgroundImage: "url('/host-bg.jpg')" }} // 🔹 Replace with your background
//   />
...
//     <h2 className="font-helvetica font-bold leading-tight tracking-[1px] mb-8 
